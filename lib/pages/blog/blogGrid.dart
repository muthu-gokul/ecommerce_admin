...
class _BlogGridState extends State<BlogGrid> {
  ...
  List<GridHeaderModel> gridHeaderList=[
    ...
    GridHeaderModel(columnName: "Upload Image",width: 200),
    GridHeaderModel(columnName: "Title",width: 200),
    GridHeaderModel(columnName: "Detail",),
    GridHeaderModel(columnName: "Views",),
          ...
          child: Column(
            children: [
              GridWithWidgetParam(
                  ...
                  showAdd: true,
                  addBtnTap: (){
                    Navigator.push(context, pr.PageRoute().fade(BlogAddNew()));
                  },
                  filterOnTap: (i){
                    setState(() {
                  ...
                  bodyWidth: width,
                  bodyWidget: Column(
                    children: pn.blogDetail.asMap().map((key, value) => MapEntry(key,
                        Container(
                          //width: width,
                          padding: bodyPadd,
                          margin: bodyMargin,
