...
class GoodsReceivedGrid extends StatefulWidget {
  const GoodsReceivedGrid({Key? key}) : super(key: key);

  @override
  _GoodsReceivedGridState createState() => _GoodsReceivedGridState();
}

class _GoodsReceivedGridState extends State<GoodsReceivedGrid> {
  late double width;
  List<GridHeaderModel> gridHeaderList=[
    GridHeaderModel(columnName: "Goods Order No",),
                              ...
                              gridHeaderList[5].isActive?Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    ActionIcon(ontap: (){
                                      Navigator.push(context, pr.PageRoute().slideFromLeftToRight(GoodsReceivedEdit()));
