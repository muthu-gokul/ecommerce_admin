...
import 'package:ecommerce_admin/pages/topOffers/topOfferAddNew.dart';
...
class TopOfferGrid extends StatefulWidget {
  const TopOfferGrid({Key? key}) : super(key: key);

  @override
  _TopOfferGridState createState() => _TopOfferGridState();
}

class _TopOfferGridState extends State<TopOfferGrid> {
  late double width;
  List<GridHeaderModel> gridHeaderList=[
    GridHeaderModel(columnName: "Offer Name",),
          ...
          child: Column(
            children: [
              GridWithWidgetParam(
                  ...
                  bodyWidth: width,
                  bodyWidget: Column(
                    children: pn.topOffer.asMap().map((key, value) => MapEntry(key,
                        Container(
                          //width: width,
                          padding: bodyPadd,
                          margin: bodyMargin,
