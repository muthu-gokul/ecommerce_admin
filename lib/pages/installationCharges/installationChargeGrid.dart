...
import 'installationChargesAddNew.dart';

class InstallationChargesGird extends StatefulWidget {
  const InstallationChargesGird({Key? key}) : super(key: key);

  @override
  _InstallationChargesGirdState createState() => _InstallationChargesGirdState();
}

class _InstallationChargesGirdState extends State<InstallationChargesGird> {
  late double width;
