...
import 'package:ecommerce_admin/pages/featuredBrand/featuredBrandAddNew.dart';
...
class FeaturedBrandGrid extends StatefulWidget {
  const FeaturedBrandGrid({Key? key}) : super(key: key);
...
class _FeaturedBrandGridState extends State<FeaturedBrandGrid> {
  ...
  List<GridHeaderModel> gridHeaderList=[
    GridHeaderModel(columnName: "Brand Name ",),
          ...
          child: Column(
            children: [
              GridWithWidgetParam(
                  ...
                  bodyWidth: width,
                  bodyWidget: Column(
                    children: pn.featuredBrand.asMap().map((key, value) => MapEntry(key,
                        Container(
                          //width: width,
                          padding: bodyPadd,
                          margin: bodyMargin,
