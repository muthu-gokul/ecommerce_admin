...
class InvoiceGrid extends StatefulWidget {
  ...
  @override
  _InvoiceGridState createState() => _InvoiceGridState();
}
...
class _InvoiceGridState extends State<InvoiceGrid> {
  ...
  List<GridHeaderModel> gridHeaderList=[
    GridHeaderModel(columnName: "Invoice No",),
    GridHeaderModel(columnName: "Invoice Date",),
  ...
  List<GridHeaderModel> gridHeaderList2=[
    GridHeaderModel(columnName: "Invoice No",),
    GridHeaderModel(columnName: "Invoice Date",),
    GridHeaderModel(columnName: "Supplier Name",width: 200),
    GridHeaderModel(columnName: "Gross Amount",),
    GridHeaderModel(columnName: "Payment Status",width: 180),
    GridHeaderModel(columnName: "Actions",width: 100),
  ];
                          ...
                          children: [
                            GestureDetector(
                              ...
                              child: Container(
                                ...
                                child: Center(
                                    ...
                                    child: Text("Receivable Invoice",style: TextStyle(fontFamily: 'RR',fontSize: 20,color: selectedTab==0?Colors.white:Colors.grey),)
                            ...
                            GestureDetector(
                              ...
                              child: Container(
                                ...
                                child: Center(
                                    child: Text("Payable Invoice",style: TextStyle(fontFamily: 'RR',fontSize: 20,color: selectedTab==1?Colors.white:Colors.grey),)
                                ),
                              ),
                            ),
                                            ...
                                            gridHeaderList[0].isActive?Container(
                                             ...
                                             // margin:  EdgeInsets.only(left: 10),
                                              ...
                                              child: Container(
                                                  ...
                                                  child: Text("${value.invNo}",style: TextStyle(fontSize: 15,color: Colors.white,fontFamily: 'RR'),)
                                              ),
                                            ):Container(),
                                            gridHeaderList[1].isActive?GridContent(
                                              width:gridHeaderList[1].width ,
