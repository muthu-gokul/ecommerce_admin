...
import 'package:ecommerce_admin/pages/holiday/holidayAddNew.dart';
...
class HolidayGrid extends StatefulWidget {


  @override
  _HolidayGridState createState() => _HolidayGridState();
}

class _HolidayGridState extends State<HolidayGrid> {
  late double width;
  List<GridHeaderModel> gridHeaderList=[
    GridHeaderModel(columnName: "Name",),
    GridHeaderModel(columnName: "From Date",),
    GridHeaderModel(columnName: "To Date"),
          ...
          child: Column(
            children: [
              GridWithWidgetParam(
                  ...
                  showAdd: true,
                  addBtnTap: (){
                   Navigator.push(context, pr.PageRoute().fade(HolidayAddNew()));
                  },
                  filterOnTap: (i){
                    setState(() {
                  ...
                  bodyWidth: width,
                  bodyWidget: Column(
                    children: pn.holidays.asMap().map((key, value) => MapEntry(key,
                        Container(
                          //width: width,
                          padding: bodyPadd,
                          margin: bodyMargin,
