...
class SubscriberListAdd extends StatefulWidget {
  const SubscriberListAdd({Key? key}) : super(key: key);

  @override
  _SubscriberListAddState createState() => _SubscriberListAddState();
}

class _SubscriberListAddState extends State<SubscriberListAdd> {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Container(
          ...
          child: Row(
            children: [
              Text("Subscriber List / Add New",style: ts18(Colors.white,fontsize: 20,fontfamily: 'RM'),),
            ],
          ),
        ),
      ),
